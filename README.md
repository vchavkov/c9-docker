...
# remove vchavkov container
docker rm -f vchavkov
...
docker run -it -d --restart=always -p 80 --name vchavkov -e C9_USER=vchavkov -e C9_PASS=vchavkov -e LOG_LEVEL=debug -v /ghost:/ghost 54d498871860
